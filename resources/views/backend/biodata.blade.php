    ...
    <form action="{{ route('biodata') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="kecamatan" id="" class="form-control @error('kecamatan')  is-invalid @enderror"
                        @if ($biodata) value="{{ $biodata->kecamatan }}"  disabled @endif>
                    @error('kecamatan')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="telepon" id="" class="form-control  @error('telepon')  is-invalid @enderror"
                        @if ($biodata) value="{{ $biodata->telepon }}"  disabled @endif>
                    @error('telepon')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="col-md-6">
                ...
                @if ($biodata)
                    <a href="/editBiodata/{{ $biodata->id_siswa }}" class="btn btn-warning" @if (!$biodata) disabled @endif> <span class="fa fa-edit"></span>
                        Edit</a>
                @endif
            </div>
        </div>
